pipeline {
     ...
     post {
          success {
              slackSend channel: '#ci', color: 'good', failOnError: true, message: "Build succeeded: '${env.BRANCH_NAME}' ${env.BUILD_NUMBER}", teamDomain: 'book-spot', tokenCredentialId: '94413a97-7f5e-456b-aa13-d8abf57fca3d'
          }
